...
**What that shape says, and it is not "81.7 % correct".** 賊剋 alone is 46 % of
...
**So the next stretch is adjudication and not fitting.** Raising these numbers
by matching the reference would be fitting this engine to forty conditionals
nobody wrote down, which is the opposite of what a reference is for. Each
disagreement class goes to 《六壬大全》 and 《六壬指南》 and is decided there,
and where this engine ends up differing deliberately that is a divergence to
